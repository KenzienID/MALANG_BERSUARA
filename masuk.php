...
<head>
    ...
    <meta charset="UTF-8">
    <title>Masuk MalangBersuara</title>
        ...
        <div class="form">
            <form action="#" method="POST">
                <h2>Silahkan Masuk</h2>
                    ...
                    <div class="inputBox">
                        <input style="text" type="password" id="password"  name="password" required="required" autocomplete="off">
                    ...
                    <br>
                    <div class="cr">
                        <p align="center" color="#1c1c1c">Tidak mempunyai akun? </p>
                        <br>
                        <a align="center" href="daftar.php" color="#1c1c1c">Daftar disini</a>
                    </div>
            </form>
        </div>
    </div>
